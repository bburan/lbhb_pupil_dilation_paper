...
parameters {
    ...
    real gain_ratio_mean;
    real<lower=0> gain_ratio_sd;
    real gain_cell_ratio[n_cells];
...
model {
    ...
    for (i in 1:n) {
        ...
        if (pupil[i] == 0) {
            ...
            gain_i = gain_cell[c] * exp(gain_cell_ratio[c]);
        }
